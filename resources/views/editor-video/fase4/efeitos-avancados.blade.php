...
<head>
    ...
    <title>EditorVideoIA - Fase 4 Entrega 3</title>
    <style>
        ...
        .badge { display:inline-block; color:#dbeafe; background:#1e3a8a; border:1px solid #60a5fa; padding:5px 9px; border-radius:999px; font-size:12px; font-weight:bold; }
...
<div class="wrap">
    <div class="hero">
        <h1>Fase 4 — Efeitos e Ajustes Avançados</h1>
        <p>Entrega 3 / Etapas 41 + 42. Base profissional para correção de cor, chroma key, máscaras, tracking, efeitos visuais, transições e efeitos sonoros.</p>
    </div>
    ...
    <div class="modules">
        @foreach($modulos as $modulo)
            <div class="module">
                ...
                <form method="POST" action="{{ route('editor-video.fase4.efeitos-avancados.executar') }}">
                    @csrf
    ...
    <div class="footer">
        <strong>Homologação:</strong> se esta página abrir, os 8 módulos aparecerem e o botão mostrar mensagem verde sem erro 404/500, a Entrega 3 da Fase 4 está validada.
    </div>
</div>
</body>
</html>
