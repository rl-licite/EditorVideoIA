...
<head>
    ...
    <title>EditorVideoIA - Fase 4 Entrega 5</title>
    <style>
        ...
        .badge { display:inline-block; color:#dcfce7; background:#14532d; border:1px solid #22c55e; padding:5px 9px; border-radius:999px; font-size:12px; font-weight:bold; }
...
<div class="wrap">
    <div class="hero">
        <h1>Fase 4 — Edição Profissional</h1>
        <p>Entrega 5 / Etapas 45 + 46. Estrutura inicial para multicâmera, color grading, chroma key profissional, motion tracking e biblioteca de efeitos avançados.</p>
    </div>
    ...
    <div class="modules">
        @foreach($modulos as $modulo)
            <div class="module">
                ...
                <form method="POST" action="{{ route('editor-video.fase4.edicao-profissional.executar') }}">
                    @csrf
                    <input type="hidden" name="acao" value="{{ \Illuminate\Support\Str::slug($modulo['titulo']) }}">
    ...
    <div class="footer">
        <strong>Homologação:</strong> se esta página abrir, os 8 módulos aparecerem e o botão mostrar mensagem verde sem erro 404/500, a Entrega 5 da Fase 4 está validada.
    </div>
</div>
</body>
</html>
