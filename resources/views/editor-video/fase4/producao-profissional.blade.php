...
<head>
    ...
    <title>EditorVideoIA - Fase 4 Entrega 1</title>
    <style>
        ...
        .badge { display:inline-block; color:#bfdbfe; background:#1e3a8a; border:1px solid #3b82f6; padding:5px 9px; border-radius:999px; font-size:12px; font-weight:bold; }
...
<div class="wrap">
    <div class="hero">
        <h1>Fase 4 — Produção Profissional</h1>
        <p>Entrega 1 / Etapas 37 + 38. Base profissional para multicâmera, cor, chroma key, máscaras, tracking, efeitos, transições e áudio.</p>
    </div>
    ...
    <div class="modules">
        @foreach($modulos as $modulo)
            <div class="module">
                ...
                <form method="POST" action="{{ route('editor-video.fase4.producao-profissional.executar') }}">
                    @csrf
    ...
    <div class="footer">
        <strong>Homologação:</strong> se esta página abrir, os 8 módulos aparecerem e o botão mostrar mensagem verde sem erro 404/500, a Entrega 1 da Fase 4 está validada.
    </div>
</div>
</body>
</html>
